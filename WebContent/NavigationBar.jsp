...
<nav class="w3-sidebar w3-bar-block w3-card w3-top w3-xlarge w3-animate-left"
	...
	<a href="javascript:void(0)" onclick="w3_close()"
		...
		<a href="worldofwords?command=getWorldCupList"
		onclick="w3_close()" class="w3-bar-item w3-button">Find out WorldCups!</a>
		<a href="foodWorldCupPrepare.jsp" onclick="w3_close()" class="w3-bar-item w3-button">food League!</a>
